        ...
        <Card className="w-full max-w-md mx-auto">
            ...
            <CardContent>
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                    ...
                    <p className="text-sm text-gray-500">
                        {t('forgotPassword')}
                        <Link href={`/${locale}/reset-password`} className="text-blue-500"> {t('resetPassword')}</Link>
                    </p>
            ...
            <CardFooter>
                <p className="w-full text-sm text-center text-gray-500">
                    <Link href={`/${locale}/register`} className="text-blue-500">{t('registerWithEmail')}</Link>
                </p>
            </CardFooter>
        </Card>
    );
